package se.jensen.project.common.aspects;
...
import se.jensen.project.common.util.GenericToStringBuilder;
...
public class TimeAndLoggImpl {
    ...
    @Around("@annotation(se.jensen.project.common.aspects.TimeAndLogg)")
